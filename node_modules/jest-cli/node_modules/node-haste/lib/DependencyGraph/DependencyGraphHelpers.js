...
var DependencyGraphHelpers = function () {
  function DependencyGraphHelpers(_ref) {
    ...
    var list = providesModuleNodeModules;
    this._hasteRegex = list && list.length ? buildHasteRegex(this._resolveHastePackages(list, roots)) : null;
    ...
    value: function _resolveHastePackages(packages, roots) {
      ...
      packages.forEach(function (p) {
        roots.forEach(function (rootDir) {
          ...
          var packagePath = packagePathForPackage({ name: name, parent: parent }, rootDir);
          try {
            ...
            hastePackages.push(packagePathForPackage({ name: name }, rootDir));
          }
        });
      });
